...
HCl=loadImage("images/HCl with F.jpg");
...
image(Al2O3,displayWidth/2,displayHeight/2);
console.log("al2o3");
 

}  else if((((Box2.x-oxygen2.x<Box2.width/2+oxygen2.width/2)&&(Box1.x-Hydrogen.x<Box1.width/2+Hydrogen.width/2)))
  ||(((Box1.x-oxygen.x<Box1.width/2+oxygen.width/2)&&(Box2.x-Hydrogen1.x<Box2.width/2+Hydrogen1.width/2)))){
 
  image(water2,displayWidth/2,displayHeight/2);
  console.log("water");
}  
else if((((Box2.x-oxygen2.x<Box2.width/2+oxygen2.width/2)&&(Box1.x-sodium.x<Box1.width/2+sodium.width/2)))
  ||(((Box1.x-oxygen.x<Box1.width/2+oxygen.width/2)&&(Box2.x-sodium2.x<Box2.width/2+sodium2.width/2)))){
  
  image(Na2O,displayWidth/2,displayHeight/2)
  console.log("na2o");
 
}      
else if((((Box1.x-copper.x<Box1.width/2+copper.width/2)&&(Box2.x-oxygen2.x<Box2.width/2+oxygen2.width/2)))
||(((Box1.x-oxygen.x<Box1.width/2+oxygen.width/2)&&(Box2.x-copper2.x<Box2.width/2+copper2.width/2)))){
  
image(CuO,displayWidth/2,displayHeight/2);
console.log("cuo");
 
}  
else if((((Box2.x-oxygen2.x<Box2.width/2+oxygen2.width/2)&&(Box1.x-Iron.x<Box1.width/2+Iron.width/2)))
||(((Box1.x-oxygen.x<Box1.width/2+oxygen.width/2)&&(Box2.x-Iron2.x<Box2.width/2+Iron2.width/2)))){
 
image(Ironoxide,displayWidth/2,displayHeight/2);
console.log("ironoxide");
 
}  
else if((((Box2.x-chlo2.x<Box2.width/2+chlo2.width/2)&&(Box1.x-copper.x<Box1.width/2+copper.width/2)))
||(((Box1.x-chlo.x<Box1.width/2+chlo.width/2)&&(Box2.x-copper2.x<Box2.width/2+copper2.width/2)))){
 image(CuCl2,displayWidth/2,displayHeight/2);
console.log("cucl2");
 
}  
else if((((Box2.x-chlo2.x<Box2.width/2+chlo2.width/2)&&(Box1.x-Hydrogen.x<Box1.width/2+Hydrogen.width/2)))
||(((Box1.x-chlo.x<Box1.width/2+chlo.width/2)&&(Box2.x-Hydrogen1.x<Box2.width/2+Hydrogen1.width/2)))){
image(HCl,displayWidth/2,displayHeight/2);
console.log("hcl");
  
}
else if((((Box2.x-chlo2.x<Box2.width/2+chlo2.width/2)&&(Box1.x-alum.x<Box1.width/2+alum.width/2)))
